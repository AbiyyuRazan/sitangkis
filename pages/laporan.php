...
body {
  ...
  background: #F1E3D6; /* Krem Krem #EF5D60 (Background Utama) */
  color: #ffffff; /* Menggunakan putih agar kontras dengan krem */
  min-height: 100vh;
  display: flex;
...
.liquid-glass {
  background: rgba(85, 116, 153, 0.75); /* Warna abu-abu kebiruan glossy sesuai rancangan awal */
...
/* SOLID COLOR BLUE (UNTUK KARTU BERITA AGAR TETAP KONTRAS DENGAN BG TERANG) */
.solid-blue-card {
  background: #91B9B6; /* Kontainer Dalam #91B9B6 */
  border-radius: 14px;
  display: flex;
  flex-direction: column;
  padding: 18px;
...
.nav-btn {
  background: #ffffff;
  color: #3b587c; /* Menyeimbangkan abu kebiruan glossy */
  padding: 8px 20px;
  border-radius: 8px;
  font-size: 0.875rem;
  font-weight: 600;
...
.page-title {
  font-size: 2rem;
  font-weight: 700;
  color: #475569; /* Diubah menjadi putih agar terlihat di krem */
  letter-spacing: -0.03em;
}
...
.search-container button {
  background: #ffffff; /* Tombol cari menjadi putih di krem */
  color: #F1E3D6; /* Teks tombol cari krem */
  border: none;
  padding: 0 16px;
  font-size: 0.85rem;
  font-weight: 600;
...
.search-container button:hover { background: #f1f5f9; }
...
.news-date {
  font-size: 0.8rem;
  color: #475569; /* Teks tanggal putih */
  font-weight: 500;
  margin-bottom: 8px;
}
.news-title {
...
.news-amount {
  font-size: 1rem;
  font-weight: 700;
  color: #475569; /* Teks jumlah putih */
}

.news-read-btn {
  font-size: 0.85rem;
  font-weight: 600;
  color: #475569; /* Teks tombol selengkapnya putih */
  text-decoration: none;
  display: inline-flex;
  align-items: center;
...
/* Tombol Selesai (Jika ada elemen yang menggunakannya) */
.btn-selesai {
  background: #DFB868; /* Selesai Selesai #DFB868 */
  color: #ffffff;
...
.empty-state {
  ...
  text-align: center;
  padding: 64px 16px;
  color: #ffffff; /* Teks kosong putih */
  font-size: 0.95rem;
}
...
.footer {
  ...
  color: #ffffff; /* Teks footer putih */
  padding: 32px 16px;
  border-top: 1px solid rgba(255, 255, 255, 0.1); /* Border footer putih transparan */
  margin-top: auto;
}
